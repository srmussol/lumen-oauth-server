...
$app->register(App\Providers\JwtClaimsServiceProvider::class);
/*
|--------------------------------------------------------------------------
...
$app->router->group([
    ...
    'middleware' => ['passport-administrators']
], function ($router) {
    require __DIR__.'/../routes/web.php';
});

Dusterio\LumenPassport\LumenPassport::routes($app,['middleware' => ['passport-administrators']]);
